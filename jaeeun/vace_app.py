...
with left:
    with st.container(key="left_rail"):
        st.markdown('<div class="rail-kicker">Beauty AI editor</div><div class="rail-copy">내 얼굴과 원하는 헤어스타일에 어울리는 컬러를 미리 확인해보세요.</div>', unsafe_allow_html=True)
