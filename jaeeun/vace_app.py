...
st.markdown(
    ...
    <style>
      ...
      .block-container{max-width:1500px;height:100vh;padding:0 1.25rem;overflow:hidden}
      ...
      .brand{display:flex;align-items:center;gap:.7rem}.brand-mark{width:2rem;height:2rem;border-radius:.65rem;background:var(--accent);color:#fff;display:grid;place-items:center;font-weight:800}.brand-name{font-size:1.05rem;font-weight:750}.brand-subtitle{color:var(--muted);font-size:.72rem;margin-left:.25rem}
...
st.markdown(f'<div class="studio-header"><div class="brand"><div class="brand-mark">AH</div><div><span class="brand-name">AI Hair Studio</span><span class="brand-subtitle">Personal Color · Hairstyle</span></div></div><div class="stepper">{step_markup}</div></div>', unsafe_allow_html=True)
