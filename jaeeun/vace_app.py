...
st.markdown(
    ...
    html,body,[data-testid="stAppViewContainer"],[data-testid="stAppViewBlockContainer"]{overflow:hidden}
    .stApp{background:#f7f7f8;color:var(--ink);height:100vh;overflow:hidden} .block-container{max-width:1500px;height:100vh;padding:0 1.25rem;overflow:hidden}
    header[data-testid="stHeader"]{display:none}
    .studio-header{height:4.25rem;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line);background:#fff}
    ...
    .editor-shell{min-height:calc(100vh - 4.25rem);background:#fff;border:1px solid var(--line);border-radius:1rem;overflow:hidden}.rail{background:#fff;border-right:1px solid var(--line);padding:1.05rem 1.15rem;min-height:calc(100vh - 4.25rem);max-height:calc(100vh - 4.25rem);overflow-y:auto}.rail-kicker{color:var(--accent);text-transform:uppercase;letter-spacing:.1em;font-size:.65rem;font-weight:800}.rail-title{font-size:1.35rem;font-weight:760;letter-spacing:-.04em;margin:.3rem 0 .2rem}.rail-copy{color:var(--muted);font-size:.76rem;line-height:1.55;margin-bottom:1rem}.section{border-top:1px solid #f0f0f2;padding:.75rem 0}.section-title{font-size:.76rem;font-weight:750;margin-bottom:.45rem}.section-number{color:var(--accent);margin-right:.35rem}.helper{color:var(--muted);font-size:.69rem;line-height:1.45}.upload-summary{background:#f7f7f8;border:1px solid var(--line);border-radius:.7rem;padding:.65rem .7rem;font-size:.75rem}.upload-summary strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.upload-summary span{color:#35a06b;font-size:.68rem}
    .color-result{display:flex;align-items:center;justify-content:space-between;background:#f5f3ff;border:1px solid #ded9ff;border-radius:.75rem;padding:.65rem}.color-result strong{display:block;font-size:.93rem}.confidence{color:var(--muted);font-size:.68rem;margin-top:.2rem}.confidence b{color:var(--accent)}.swatch{display:inline-block;width:.85rem;height:.85rem;border-radius:50%;vertical-align:-.08rem;margin-right:.45rem;border:1px solid rgba(0,0,0,.12)}.recommendation-row{display:flex;align-items:center;gap:.55rem;padding:.28rem .1rem;font-size:.75rem}.recommendation-row small{color:var(--muted);margin-left:auto}
    .preview-zone{background:var(--canvas);padding:1rem 1.35rem .8rem;min-height:calc(100vh - 4.25rem);max-height:calc(100vh - 4.25rem);overflow:hidden}.preview-toolbar{display:flex;align-items:center;justify-content:space-between;min-height:2rem}.preview-label{color:var(--muted);text-transform:uppercase;letter-spacing:.11em;font-size:.64rem;font-weight:800}.preview-title{font-size:.85rem;font-weight:700;margin-top:.2rem}.canvas{height:calc(100vh - 20rem);min-height:20rem;display:flex;align-items:center;justify-content:center;padding:1.25rem;background:#e5e7eb;border-radius:.85rem;overflow:hidden}.canvas img{max-height:100%;max-width:100%;object-fit:contain;border-radius:.35rem}.empty-canvas{text-align:center;color:var(--muted);font-size:.85rem;line-height:1.6}.empty-icon{width:2.8rem;height:2.8rem;border-radius:.8rem;display:grid;place-items:center;background:#fff;margin:0 auto .7rem;color:var(--accent);font-size:1.25rem}
